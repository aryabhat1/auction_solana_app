...
impl <'info> AuctionStart<'info> {                   // done
    pub fn into_treasury_transfer_context(&self) -> CpiContext<'info, 'info, 'info, 'info, Transfer<'info>>{
...
impl<'info> AuctionEnd<'info> {
    pub fn into_initializer_transfer_context(&self) -> CpiContext<'info, 'info, 'info, 'info, Transfer<'info>>{
        let accounts = Transfer{
...
pub fn into_bidder_transfer_context(&self) -> CpiContext<'info, 'info, 'info, 'info, Transfer<'info>>{
    let accounts = Transfer{
        from: self.treasury.to_account_info(),
